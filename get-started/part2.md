...
After downloading the project, take a look at the file called <span class='definition'>`Dockerfile`</span> in the bulletin board application. Dockerfiles describe <span class='important'>how to assemble a private filesystem for a container</span>, and can also contain some metadata describing <span class='definition'>how to run a container</span> based on this image.
